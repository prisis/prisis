...
- [faker-js/faker](https://github.com/faker-js/faker) ([v7.5.0](https://github.com/faker-js/faker/releases/tag/v7.5.0), today) - Generate massive amounts of fake data in the browser and node.js
