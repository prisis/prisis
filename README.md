...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v5.0.4](https://github.com/anolilab/renovate-config/releases/tag/v5.0.4), 4 days ago) - Shareable config for Renovate (renovatebot.com)
