...
- [anolilab/next.js-template](https://github.com/anolilab/next.js-template) - Provides a GitHub repository template for Next.js, using Preact, tailwindcss, i18n and seo. (4 weeks ago)
...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.38.3](https://github.com/blitz-js/blitz/releases/tag/v0.38.3), 2 days ago) - ⚡️The Fullstack React Framework — built on Next.js
