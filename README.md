...
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v11.0.0](https://github.com/anolilab/workflows/releases/tag/v11.0.0), 4 days ago) - Shared Github Actions for Node.js projects and Monorepos.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v14.0.0](https://github.com/anolilab/renovate-config/releases/tag/v14.0.0), 4 days ago) - Shareable config for Renovate (renovatebot.com)
