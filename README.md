...
- [faker-js/faker](https://github.com/faker-js/faker) ([v7.6.0](https://github.com/faker-js/faker/releases/tag/v7.6.0), 1 day ago) - Generate massive amounts of fake data in the browser and node.js
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v2.0.0-beta.11](https://github.com/blitz-js/blitz/releases/tag/v2.0.0-beta.11), 2 days ago) - ⚡️ The Missing Fullstack Toolkit for Next.js
