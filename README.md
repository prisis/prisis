...
- [anolilab/unplugin-favicons](https://github.com/anolilab/unplugin-favicons) ([v1.0.5](https://github.com/anolilab/unplugin-favicons/releases/tag/v1.0.5), today) - Generate favicons for your project with caching for blazing fast rebuilds.
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/cerebro@1.1.16](https://github.com/visulima/visulima/releases/tag/%40visulima/cerebro%401.1.16), 5 days ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
