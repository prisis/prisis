...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) - ⚡️ The Missing Fullstack Toolkit for Next.js (4 weeks ago)
...
- [faker-js/faker](https://github.com/faker-js/faker) ([v7.5.0](https://github.com/faker-js/faker/releases/tag/v7.5.0), 1 week ago) - Generate massive amounts of fake data in the browser and node.js
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v2.0.0-beta.3](https://github.com/blitz-js/blitz/releases/tag/v2.0.0-beta.3), 2 weeks ago) - ⚡️ The Missing Fullstack Toolkit for Next.js
