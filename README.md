...
- [anolilab/monorepo-template](https://github.com/anolilab/monorepo-template) - Provides a GitHub mono repository template for a Anolilab Node libraries, using GitHub actions. (4 weeks ago)
...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/cerebro@1.1.24](https://github.com/visulima/visulima/releases/tag/%40visulima/cerebro%401.1.24), 1 week ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
- [visulima/packem](https://github.com/visulima/packem) ([@visulima/packem@1.0.8](https://github.com/visulima/packem/releases/tag/%40visulima/packem%401.0.8), 1 week ago) - A fast and modern bundler for Node.js and TypeScript.
