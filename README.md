...
- [prisis/resume](https://github.com/prisis/resume) - My Résumé (6 days ago)
...
- [anolilab/javascript-style-guide](https://github.com/anolilab/javascript-style-guide) ([@anolilab/semantic-release-preset@2.0.6](https://github.com/anolilab/javascript-style-guide/releases/tag/%40anolilab%2Fsemantic-release-preset%402.0.6), 1 day ago) - This project is a code style guide of all basic back- and front end project used at Anolilab.
- [faker-js/faker](https://github.com/faker-js/faker) ([v7.1.0](https://github.com/faker-js/faker/releases/tag/v7.1.0), 1 week ago) - Generate massive amounts of fake data in the browser and node.js
