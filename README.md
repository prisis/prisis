...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.38.3-canary.1](https://github.com/blitz-js/blitz/releases/tag/v0.38.3-canary.1), 2 days ago) - ⚡️The Fullstack React Framework — built on Next.js
