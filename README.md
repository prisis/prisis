...
- [prisis/ender-3-pro-klipper](https://github.com/prisis/ender-3-pro-klipper) - Klipper configuration for my Ender 3 pro (voron) (today)
...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v2.0.0-beta.27](https://github.com/blitz-js/blitz/releases/tag/v2.0.0-beta.27), 3 days ago) - ⚡️ The Missing Fullstack Toolkit for Next.js
- [faker-js/faker](https://github.com/faker-js/faker) ([v8.0.0-beta.0](https://github.com/faker-js/faker/releases/tag/v8.0.0-beta.0), 5 days ago) - Generate massive amounts of fake data in the browser and node.js
