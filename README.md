...
- [faker-js/core](https://github.com/faker-js/core) - Generate massive amounts of realistic fake data in Node.js and the browser (2 days ago)
...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.45.0](https://github.com/blitz-js/blitz/releases/tag/v0.45.0), 1 day ago) - ⚡️The Fullstack React Framework — built on Next.js
