...
- [anolilab/unplugin-favicons](https://github.com/anolilab/unplugin-favicons) ([v1.0.5-alpha.1](https://github.com/anolilab/unplugin-favicons/releases/tag/v1.0.5-alpha.1), today) - Generate favicons for your project with caching for blazing fast rebuilds.
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/cerebro@1.1.14](https://github.com/visulima/visulima/releases/tag/%40visulima/cerebro%401.1.14), 2 days ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
- [BridgeAR/safe-stable-stringify](https://github.com/BridgeAR/safe-stable-stringify) ([v2.5.0](https://github.com/BridgeAR/safe-stable-stringify/releases/tag/v2.5.0), 5 days ago) - Safe, deterministic and fast serialization alternative to JSON.stringify.
