...
- [faker-js/faker](https://github.com/faker-js/faker) ([v7.2.0](https://github.com/faker-js/faker/releases/tag/v7.2.0), 3 days ago) - Generate massive amounts of fake data in the browser and node.js
- [anolilab/javascript-style-guide](https://github.com/anolilab/javascript-style-guide) ([@anolilab/eslint-config@4.0.8](https://github.com/anolilab/javascript-style-guide/releases/tag/%40anolilab%2Feslint-config%404.0.8), 5 days ago) - This project is a code style guide of all basic back- and front end project used at Anolilab.
