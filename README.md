...
- [anolilab/nxt](https://github.com/anolilab/nxt) - Provides a GitHub repository template for Next.js, using i18n and seo. (3 days ago)
...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.38.6](https://github.com/blitz-js/blitz/releases/tag/v0.38.6), 1 day ago) - ⚡️The Fullstack React Framework — built on Next.js
- [anolilab/javascript-style-guide](https://github.com/anolilab/javascript-style-guide) ([@anolilab/stylelint-config@2.1.1](https://github.com/anolilab/javascript-style-guide/releases/tag/%40anolilab%2Fstylelint-config%402.1.1), 1 day ago) - This project is a code style guide of all basic back- and front end project used at Anolilab.
