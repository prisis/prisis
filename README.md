...
- [anolilab/zod-prisma](https://github.com/anolilab/zod-prisma) ([@anolilab/zod-dto@1.3.0](https://github.com/anolilab/zod-prisma/releases/tag/%40anolilab%2Fzod-dto%401.3.0), 2 days ago) - Helpful packages to work with prisma and zod.
- [anolilab/javascript-style-guide](https://github.com/anolilab/javascript-style-guide) ([@anolilab/textlint-config@3.0.0](https://github.com/anolilab/javascript-style-guide/releases/tag/%40anolilab%2Ftextlint-config%403.0.0), 4 days ago) - This project is a code style guide of all basic back- and front end project used at Anolilab.
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.44.4](https://github.com/blitz-js/blitz/releases/tag/v0.44.4), 5 days ago) - ⚡️The Fullstack React Framework — built on Next.js
