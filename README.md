...
- [faker-js/faker](https://github.com/faker-js/faker) ([v7.2.0](https://github.com/faker-js/faker/releases/tag/v7.2.0), 2 weeks ago) - Generate massive amounts of fake data in the browser and node.js
