...
- [faker-js/faker](https://github.com/faker-js/faker) ([v8.0.0-beta.0](https://github.com/faker-js/faker/releases/tag/v8.0.0-beta.0), 2 days ago) - Generate massive amounts of fake data in the browser and node.js
- [dasmeta/terraform-auth0-modules](https://github.com/dasmeta/terraform-auth0-modules) ([v1.6.1](https://github.com/dasmeta/terraform-auth0-modules/releases/tag/v1.6.1), 4 days ago) - Terraform modules from DasMeta to manage auth0 setup
...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v2.0.0-beta.26](https://github.com/blitz-js/blitz/releases/tag/v2.0.0-beta.26), 3 weeks ago) - ⚡️ The Missing Fullstack Toolkit for Next.js
