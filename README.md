...
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v9.0.1](https://github.com/anolilab/workflows/releases/tag/v9.0.1), 2 days ago) - Shared Github Actions for Node.js projects and Monorepos.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v12.0.0](https://github.com/anolilab/renovate-config/releases/tag/v12.0.0), 4 days ago) - Shareable config for Renovate (renovatebot.com)
- [anolilab/javascript-style-guide](https://github.com/anolilab/javascript-style-guide) ([@anolilab/lint-staged-config@3.1.1](https://github.com/anolilab/javascript-style-guide/releases/tag/%40anolilab/lint-staged-config%403.1.1), 5 days ago) - This project is a code style guide of all basic back- and front end project used at Anolilab.
