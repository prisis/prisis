...
- [prisis/resume](https://github.com/prisis/resume) - My Résumé (today)
...
- [faker-js/faker](https://github.com/faker-js/faker) ([v7.1.0](https://github.com/faker-js/faker/releases/tag/v7.1.0), 1 day ago) - Generate massive amounts of fake data in the browser and node.js
