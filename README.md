...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v11.0.1](https://github.com/anolilab/renovate-config/releases/tag/v11.0.1), today) - Shareable config for Renovate (renovatebot.com)
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v8.0.0](https://github.com/anolilab/workflows/releases/tag/v8.0.0), today) - Shared Github Actions for Node.js projects and Monorepos.
