...
- [prosopo/captcha](https://github.com/prosopo/captcha) ([v3.6.60](https://github.com/prosopo/captcha/releases/tag/v3.6.60), today) - Open-source, frictionless CAPTCHA and bot defense. A privacy-focused alternative to reCAPTCHA and hCaptcha.
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v20.2.5](https://github.com/anolilab/workflows/releases/tag/v20.2.5), today) - Shared Github Actions for Node.js projects and Monorepos.
