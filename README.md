...
- [prisis/posthog-reverse-proxy](https://github.com/prisis/posthog-reverse-proxy) - Posthog Reverse Proxy (5 days ago)
...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v6.0.0](https://github.com/anolilab/renovate-config/releases/tag/v6.0.0), 1 day ago) - Shareable config for Renovate (renovatebot.com)
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v4.0.0](https://github.com/anolilab/workflows/releases/tag/v4.0.0), 6 days ago) - Shared Github Actions for Node.js projects and Monorepos.
