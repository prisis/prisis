...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/package@3.5.4](https://github.com/visulima/visulima/releases/tag/%40visulima/package%403.5.4), 2 days ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v5.0.1](https://github.com/anolilab/renovate-config/releases/tag/v5.0.1), 4 weeks ago) - Shareable config for Renovate (renovatebot.com)
