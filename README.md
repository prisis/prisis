...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v10.0.2](https://github.com/anolilab/renovate-config/releases/tag/v10.0.2), 1 day ago) - Shareable config for Renovate (renovatebot.com)
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v6.1.9](https://github.com/anolilab/workflows/releases/tag/v6.1.9), 5 days ago) - Shared Github Actions for Node.js projects and Monorepos.
