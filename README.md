...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/error@2.0.0](https://github.com/visulima/visulima/releases/tag/%40visulima/error%402.0.0), today) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v3.0.0](https://github.com/anolilab/renovate-config/releases/tag/v3.0.0), 1 day ago) - Shareable config for Renovate (renovatebot.com)
