...
- [prisis/broken-ssr](https://github.com/prisis/broken-ssr) -  (today)
...
- [faker-js/faker](https://github.com/faker-js/faker) ([v6.2.0](https://github.com/faker-js/faker/releases/tag/v6.2.0), 4 days ago) - Generate massive amounts of fake data in the browser and node.js
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.45.4](https://github.com/blitz-js/blitz/releases/tag/v0.45.4), 1 week ago) - ⚡️The Fullstack React Framework — built on Next.js
