...
- [anolilab/singlerepo-template](https://github.com/anolilab/singlerepo-template) - Provides a GitHub single repository template for a Anolilab Node library, using GitHub actions. (2 days ago)
...
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v2.0.1](https://github.com/anolilab/workflows/releases/tag/v2.0.1), 1 day ago) - Shared Github Actions for Node.js projects and Monorepos.
