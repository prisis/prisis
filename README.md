...
- [narrowspark/template-sync-action](https://github.com/narrowspark/template-sync-action) - :arrows_counterclockwise: Github action to sync repository with a template repository (2 days ago)
...
- [anolilab/blitz-webpack-utils](https://github.com/anolilab/blitz-webpack-utils) - Webpack utils for Blitz.js (5 days ago)
...
- [anolilab/zod-prisma](https://github.com/anolilab/zod-prisma) ([@anolilab/zod-dto@1.1.1](https://github.com/anolilab/zod-prisma/releases/tag/%40anolilab%2Fzod-dto%401.1.1), 2 days ago) - Helpful packages to work with prisma and zod.
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.40.0-canary.9](https://github.com/blitz-js/blitz/releases/tag/v0.40.0-canary.9), 3 days ago) - ⚡️The Fullstack React Framework — built on Next.js
