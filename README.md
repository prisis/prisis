...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v10.0.3](https://github.com/anolilab/renovate-config/releases/tag/v10.0.3), 4 days ago) - Shareable config for Renovate (renovatebot.com)
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v6.1.11](https://github.com/anolilab/workflows/releases/tag/v6.1.11), 4 days ago) - Shared Github Actions for Node.js projects and Monorepos.
