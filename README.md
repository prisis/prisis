...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v14.0.1](https://github.com/anolilab/renovate-config/releases/tag/v14.0.1), 1 week ago) - Shareable config for Renovate (renovatebot.com)
