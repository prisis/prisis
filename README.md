...
- [anolilab/javascript-style-guide](https://github.com/anolilab/javascript-style-guide) ([@anolilab/lint-staged-config@3.0.25](https://github.com/anolilab/javascript-style-guide/releases/tag/%40anolilab/lint-staged-config%403.0.25), 1 day ago) - This project is a code style guide of all basic back- and front end project used at Anolilab.
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v6.1.15](https://github.com/anolilab/workflows/releases/tag/v6.1.15), 2 days ago) - Shared Github Actions for Node.js projects and Monorepos.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v10.0.4](https://github.com/anolilab/renovate-config/releases/tag/v10.0.4), 4 days ago) - Shareable config for Renovate (renovatebot.com)
