...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v9.0.2](https://github.com/anolilab/renovate-config/releases/tag/v9.0.2), 5 days ago) - Shareable config for Renovate (renovatebot.com)
