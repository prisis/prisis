...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v12.0.1](https://github.com/anolilab/renovate-config/releases/tag/v12.0.1), today) - Shareable config for Renovate (renovatebot.com)
