...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v10.0.7](https://github.com/anolilab/renovate-config/releases/tag/v10.0.7), 5 days ago) - Shareable config for Renovate (renovatebot.com)
