...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/api-platform@2.0.15](https://github.com/visulima/visulima/releases/tag/%40visulima/api-platform%402.0.15), 5 days ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v3.0.0](https://github.com/anolilab/renovate-config/releases/tag/v3.0.0), 1 week ago) - Shareable config for Renovate (renovatebot.com)
