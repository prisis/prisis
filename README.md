...
- [anolilab/.github](https://github.com/anolilab/.github) - Anolilab Organization Templates (4 weeks ago)
...
- [faker-js/faker](https://github.com/faker-js/faker) ([v6.1.1](https://github.com/faker-js/faker/releases/tag/v6.1.1), 2 days ago) - Generate massive amounts of fake data in the browser and node.js
- [anolilab/zod-prisma](https://github.com/anolilab/zod-prisma) ([@anolilab/prisma-schema-reader@2.0.0](https://github.com/anolilab/zod-prisma/releases/tag/%40anolilab%2Fprisma-schema-reader%402.0.0), 4 weeks ago) - Helpful packages to work with prisma and zod.
