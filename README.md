...
- [anolilab/unplugin-favicons](https://github.com/anolilab/unplugin-favicons) ([v1.0.5](https://github.com/anolilab/unplugin-favicons/releases/tag/v1.0.5), 1 day ago) - Generate favicons for your project with caching for blazing fast rebuilds.
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/cerebro@1.1.16](https://github.com/visulima/visulima/releases/tag/%40visulima/cerebro%401.1.16), 6 days ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v4.0.2](https://github.com/anolilab/renovate-config/releases/tag/v4.0.2), 4 weeks ago) - Shareable config for Renovate (renovatebot.com)
...
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v2.6.4](https://github.com/anolilab/workflows/releases/tag/v2.6.4), 2 months ago) - Shared Github Actions for Node.js projects and Monorepos.
