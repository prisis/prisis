...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([blitz@2.0.0-alpha.22](https://github.com/blitz-js/blitz/releases/tag/blitz%402.0.0-alpha.22), today) - ⚡️The Fullstack React Framework — built on Next.js
- [anolilab/javascript-style-guide](https://github.com/anolilab/javascript-style-guide) ([@anolilab/textlint-config@4.0.2](https://github.com/anolilab/javascript-style-guide/releases/tag/%40anolilab%2Ftextlint-config%404.0.2), 2 days ago) - This project is a code style guide of all basic back- and front end project used at Anolilab.
