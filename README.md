...
- [anolilab/javascript-style-guide](https://github.com/anolilab/javascript-style-guide) ([@anolilab/eslint-config@14.0.1](https://github.com/anolilab/javascript-style-guide/releases/tag/%40anolilab/eslint-config%4014.0.1), 2 days ago) - This project is a code style guide of all basic back- and front end project used at Anolilab.
- [readmeio/oas](https://github.com/readmeio/oas) ([21.1.2](https://github.com/readmeio/oas/releases/tag/21.1.2), 2 days ago) - Comprehensive tooling for working with OpenAPI definitions.
- [readmeio/oas-to-har](https://github.com/readmeio/oas-to-har) ([23.0.8](https://github.com/readmeio/oas-to-har/releases/tag/23.0.8), 3 days ago) - Utility to transform an OpenAPI operation into a HAR representation
...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/api-platform@2.0.2](https://github.com/visulima/visulima/releases/tag/%40visulima/api-platform%402.0.2), 2 weeks ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
