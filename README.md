...
- [anolilab/skills](https://github.com/anolilab/skills) - Skills for Real Engineers. Straight from my .agents directory. (3 days ago)
...
- [prosopo/captcha](https://github.com/prosopo/captcha) ([v3.8.4](https://github.com/prosopo/captcha/releases/tag/v3.8.4), 2 days ago) - Open-source, frictionless CAPTCHA and bot defense. A privacy-focused alternative to reCAPTCHA and hCaptcha.
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v23.0.3](https://github.com/anolilab/workflows/releases/tag/v23.0.3), 2 days ago) - Shared Github Actions for Node.js projects and Monorepos.
