...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v10.0.14](https://github.com/anolilab/renovate-config/releases/tag/v10.0.14), today) - Shareable config for Renovate (renovatebot.com)
