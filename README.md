...
- [faker-js/faker](https://github.com/faker-js/faker) ([v8.0.0-alpha.0](https://github.com/faker-js/faker/releases/tag/v8.0.0-alpha.0), 3 days ago) - Generate massive amounts of fake data in the browser and node.js
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/api-platform@1.2.0](https://github.com/visulima/visulima/releases/tag/%40visulima/api-platform%401.2.0), 4 days ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
