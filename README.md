...
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v10.0.0](https://github.com/anolilab/workflows/releases/tag/v10.0.0), 1 day ago) - Shared Github Actions for Node.js projects and Monorepos.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v13.0.0](https://github.com/anolilab/renovate-config/releases/tag/v13.0.0), 1 day ago) - Shareable config for Renovate (renovatebot.com)
- [anolilab/javascript-style-guide](https://github.com/anolilab/javascript-style-guide) ([@anolilab/stylelint-config@8.0.0](https://github.com/anolilab/javascript-style-guide/releases/tag/%40anolilab/stylelint-config%408.0.0), 5 days ago) - This project is a code style guide of all basic back- and front end project used at Anolilab.
