...
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v8.0.4](https://github.com/anolilab/workflows/releases/tag/v8.0.4), today) - Shared Github Actions for Node.js projects and Monorepos.
