...
- [faker-js/faker](https://github.com/faker-js/faker) ([v7.0.1](https://github.com/faker-js/faker/releases/tag/v7.0.1), today) - Generate massive amounts of fake data in the browser and node.js
