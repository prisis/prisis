...
- [sindresorhus/parse-json](https://github.com/sindresorhus/parse-json) - Parse JSON with more helpful errors (1 week ago)
...
- [sindresorhus/parse-json](https://github.com/sindresorhus/parse-json) ([v8.0.1](https://github.com/sindresorhus/parse-json/releases/tag/v8.0.1), 6 days ago) - Parse JSON with more helpful errors
