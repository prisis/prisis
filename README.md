...
- [prosopo/captcha](https://github.com/prosopo/captcha) ([v3.6.44](https://github.com/prosopo/captcha/releases/tag/v3.6.44), 1 day ago) - Open-source, frictionless CAPTCHA and bot defense. A privacy-focused alternative to reCAPTCHA and hCaptcha.
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v19.0.4](https://github.com/anolilab/workflows/releases/tag/v19.0.4), 4 days ago) - Shared Github Actions for Node.js projects and Monorepos.
