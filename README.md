...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/api-platform@3.0.1](https://github.com/visulima/visulima/releases/tag/%40visulima/api-platform%403.0.1), 1 day ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v2.2.0](https://github.com/anolilab/workflows/releases/tag/v2.2.0), 1 day ago) - Shared Github Actions for Node.js projects and Monorepos.
- [anolilab/semantic-release](https://github.com/anolilab/semantic-release) ([@anolilab/semantic-release-preset@8.1.0](https://github.com/anolilab/semantic-release/releases/tag/%40anolilab/semantic-release-preset%408.1.0), 1 day ago) - A multi semantic release tool for monorepos.
