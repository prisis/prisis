...
- [anolilab/ai-models](https://github.com/anolilab/ai-models) - Explore a comprehensive registry of AI models from leading providers. Find the perfect AI model for your project with detailed information, comparisons, and provider details. (4 weeks ago)
...
- [prosopo/captcha](https://github.com/prosopo/captcha) ([v3.6.10](https://github.com/prosopo/captcha/releases/tag/v3.6.10), 2 days ago) - Open-source, frictionless CAPTCHA and bot defense. A privacy-focused alternative to reCAPTCHA and hCaptcha.
- [anolilab/semantic-release](https://github.com/anolilab/semantic-release) ([@anolilab/semantic-release-preset@13.4.3](https://github.com/anolilab/semantic-release/releases/tag/%40anolilab/semantic-release-preset%4013.4.3), 5 days ago) - A multi semantic release tool for monorepos.
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v13.0.1](https://github.com/anolilab/workflows/releases/tag/v13.0.1), 1 week ago) - Shared Github Actions for Node.js projects and Monorepos.
...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v14.0.2](https://github.com/anolilab/renovate-config/releases/tag/v14.0.2), 2 weeks ago) - Shareable config for Renovate (renovatebot.com)
