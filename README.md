...
- [anolilab/unplugin-favicons](https://github.com/anolilab/unplugin-favicons) ([v1.0.0](https://github.com/anolilab/unplugin-favicons/releases/tag/v1.0.0), today) - Generate favicons for your project with caching for blazing fast rebuilds.
