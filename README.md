...
- [anolilab/anole.chat](https://github.com/anolilab/anole.chat) - A modern, feature-rich AI chat application built with React, Convex, and the Vercel AI SDK. Chat with multiple AI models, manage conversations with advanced tools, and enjoy a seamless real-time experience. (2 days ago)
...
- [visulima/packem](https://github.com/visulima/packem) ([@visulima/packem@1.19.5](https://github.com/visulima/packem/releases/tag/%40visulima/packem%401.19.5), today) - A fast and modern bundler for Node.js and TypeScript.
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v6.1.4](https://github.com/anolilab/workflows/releases/tag/v6.1.4), today) - Shared Github Actions for Node.js projects and Monorepos.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v9.0.2](https://github.com/anolilab/renovate-config/releases/tag/v9.0.2), 1 day ago) - Shareable config for Renovate (renovatebot.com)
- [anolilab/semantic-release](https://github.com/anolilab/semantic-release) ([@anolilab/multi-semantic-release@2.0.0](https://github.com/anolilab/semantic-release/releases/tag/%40anolilab/multi-semantic-release%402.0.0), 3 days ago) - A multi semantic release tool for monorepos.
