...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/cerebro@1.1.30](https://github.com/visulima/visulima/releases/tag/%40visulima/cerebro%401.1.30), 1 day ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
- [unjs/pathe](https://github.com/unjs/pathe) ([v2.0.0](https://github.com/unjs/pathe/releases/tag/v2.0.0), 6 days ago) - 🛣️ Drop-in replacement of the Node.js&#39;s path module module that ensures paths are normalized
