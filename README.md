...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v19.0.2](https://github.com/anolilab/renovate-config/releases/tag/v19.0.2), today) - Shareable config for Renovate (renovatebot.com)
