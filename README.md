...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/cerebro@1.0.45](https://github.com/visulima/visulima/releases/tag/%40visulima/cerebro%401.0.45), 1 day ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v2.3.0](https://github.com/anolilab/workflows/releases/tag/v2.3.0), 3 days ago) - Shared Github Actions for Node.js projects and Monorepos.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v4.0.1](https://github.com/anolilab/renovate-config/releases/tag/v4.0.1), 4 days ago) - Shareable config for Renovate (renovatebot.com)
- [anolilab/semantic-release](https://github.com/anolilab/semantic-release) ([@anolilab/semantic-release-preset@9.0.0](https://github.com/anolilab/semantic-release/releases/tag/%40anolilab/semantic-release-preset%409.0.0), 4 days ago) - A multi semantic release tool for monorepos.
