...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) - ⚡️ The Missing Fullstack Toolkit for Next.js (7 months ago)
...
- [faker-js/faker](https://github.com/faker-js/faker) ([v8.0.0-alpha.1](https://github.com/faker-js/faker/releases/tag/v8.0.0-alpha.1), 2 days ago) - Generate massive amounts of fake data in the browser and node.js
