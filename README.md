...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/nextra-theme-docs@1.0.1](https://github.com/visulima/visulima/releases/tag/%40visulima/nextra-theme-docs%401.0.1), today) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
...
- [faker-js/faker](https://github.com/faker-js/faker) ([v7.6.0](https://github.com/faker-js/faker/releases/tag/v7.6.0), 1 month ago) - Generate massive amounts of fake data in the browser and node.js
