...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/cerebro@1.1.15](https://github.com/visulima/visulima/releases/tag/%40visulima/cerebro%401.1.15), 3 days ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v4.0.2](https://github.com/anolilab/renovate-config/releases/tag/v4.0.2), 4 days ago) - Shareable config for Renovate (renovatebot.com)
- [anolilab/unplugin-favicons](https://github.com/anolilab/unplugin-favicons) ([v1.0.5-alpha.1](https://github.com/anolilab/unplugin-favicons/releases/tag/v1.0.5-alpha.1), 5 days ago) - Generate favicons for your project with caching for blazing fast rebuilds.
