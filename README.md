...
- [anolilab/unplugin-favicons](https://github.com/anolilab/unplugin-favicons) ([v1.0.3](https://github.com/anolilab/unplugin-favicons/releases/tag/v1.0.3), 2 weeks ago) - Generate favicons for your project with caching for blazing fast rebuilds.
