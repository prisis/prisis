...
- [visulima/visulima](https://github.com/visulima/visulima) ([@visulima/api-platform@3.0.0](https://github.com/visulima/visulima/releases/tag/%40visulima/api-platform%403.0.0), 4 days ago) - Visulima is the next-gen JavaScript framework for JAMStack blogs, sites &amp; apps.
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v4.0.0](https://github.com/anolilab/renovate-config/releases/tag/v4.0.0), 4 days ago) - Shareable config for Renovate (renovatebot.com)
