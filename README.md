...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v5.0.3](https://github.com/anolilab/renovate-config/releases/tag/v5.0.3), 5 days ago) - Shareable config for Renovate (renovatebot.com)
