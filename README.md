...
- [anolilab/workflows](https://github.com/anolilab/workflows) ([v24.0.4](https://github.com/anolilab/workflows/releases/tag/v24.0.4), today) - Shared Github Actions for Node.js projects and Monorepos.
- [prosopo/captcha](https://github.com/prosopo/captcha) ([v3.8.11](https://github.com/prosopo/captcha/releases/tag/v3.8.11), today) - Open-source, frictionless CAPTCHA and bot defense. A privacy-focused alternative to reCAPTCHA and hCaptcha.
