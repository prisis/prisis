...
- [faker-js/faker](https://github.com/faker-js/faker) ([v6.3.1](https://github.com/faker-js/faker/releases/tag/v6.3.1), 2 days ago) - Generate massive amounts of fake data in the browser and node.js
