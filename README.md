...
- [prosopo/captcha](https://github.com/prosopo/captcha) ([v3.7.23](https://github.com/prosopo/captcha/releases/tag/v3.7.23), today) - Open-source, frictionless CAPTCHA and bot defense. A privacy-focused alternative to reCAPTCHA and hCaptcha.
