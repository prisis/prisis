...
- [anolilab/renovate-config](https://github.com/anolilab/renovate-config) ([v1.1.0](https://github.com/anolilab/renovate-config/releases/tag/v1.1.0), 1 day ago) - Shareable config for Renovate (renovatebot.com)
