...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) - ⚡️The Fullstack React Framework — built on Next.js (1 day ago)
...
- [narrowspark/security-advisories](https://github.com/narrowspark/security-advisories) - PHP Security Advisories Database as a JSON file (1 week ago)
...
- [blitz-js/blitz](https://github.com/blitz-js/blitz) ([v0.38.1](https://github.com/blitz-js/blitz/releases/tag/v0.38.1), 1 day ago) - ⚡️The Fullstack React Framework — built on Next.js
- [anolilab/blitzjs-swagger-recipe](https://github.com/anolilab/blitzjs-swagger-recipe) ([v2.0.0](https://github.com/anolilab/blitzjs-swagger-recipe/releases/tag/v2.0.0), 6 days ago) - BlitzJS recipe for installing Swagger.
- [drashland/deno-drash-middleware](https://github.com/drashland/deno-drash-middleware) ([v0.7.7](https://github.com/drashland/deno-drash-middleware/releases/tag/v0.7.7), 1 week ago) - A middleware library for Drash
